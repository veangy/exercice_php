                                    ...
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                            ...
                                            <div class="d-flex justify-content-center small text-warning mb-2">
                                              ...
                                              <?php 
                                              if(!empty($key_allarticles['commentaire']['star']) && !empty($key_allarticles['commentaire']['row'])){ ?>
                                              <?php echo $key_allarticles['commentaire']['star']; ?>
                                               

                                              <?php echo $key_allarticles['commentaire']['row']; ?>
